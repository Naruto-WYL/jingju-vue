...
export const streamColorsStroke = ['#5f82c8', '#36a8b6', '#e68a57', '#aa72c8', '#d84f5d', '#8f2f24']
export const streamColorsFill = [
  'rgba(95,130,200,0.08)',
  'rgba(54,168,182,0.08)',
  'rgba(230,138,87,0.08)',
  'rgba(170,114,200,0.08)',
  'rgba(216,79,93,0.08)',
  'rgba(143,47,36,0.08)',
]

export const compareKeys = ['flat', 'frontPeak', 'backPeak', 'midPeak', 'multiPeak']
export const compareColorsStroke = ['#5f82c8', '#d84f5d', '#e68a57', '#36a8b6', '#aa72c8']
